...
#define TS_INTERFACE_RX_ONLY_PARALLEL 6
#define TS_INTERFACE_RX_ONLY_SERIAL 7

/* For RFFC2072 issue. Add by JK. */
#define RF_RELOCK_MONITOR 1				// RFFC2072 relock detect 0: OFF
...
typedef struct {
	Dword startFrequency;		// unit: k Hz
	// below from eeprom
	Word rawFrequency;			// unit: M Hz
	int  alanogGainValue;
