/**
 * Copyright (c) 2017 ITE Corporation. All rights reserved. 
 *
 * Module Name:
 *   it951x-core.h
 *
...
#define RETURN_CHANNEL 1				//	Return Channel 0: OFF
...
#define USB_it951x_MINOR_RANGE 32
#define USB_it91xx_MINOR_RANGE 31
#ifdef CONFIG_USB_DYNAMIC_MINORS
#define USB_it91xx_MINOR_BASE	0
#define USB_it951x_MINOR_BASE	USB_it91xx_MINOR_RANGE
#else
#define USB_it91xx_MINOR_BASE	192
#define USB_it951x_MINOR_BASE	192 + USB_it91xx_MINOR_RANGE
#endif

/** USB Handler table for register kernel. **/
#define TX_MAX_USB_HANDLE_NUM USB_it951x_MINOR_RANGE
#define RX_MAX_USB_HANDLE_NUM USB_it91xx_MINOR_RANGE
...
extern int dvb_usb_it951x_debug;
...
typedef struct _DEVICE_CONTEXT {
	...
	IT9510INFO modulator;               // IT9510 Modulator struct.
//	Byte chipNumber;   
...
typedef struct it951x_urb_context{
...
//extern int it951x_device_count;
...
extern DWORD DL_DetectLockSignal(void *handle);
