...
#define ModulatorError_READ_EEPROM_FAIL					0x00000052ul
#define ModulatorError_SLOW_CLK_FAIL					0x00000053ul
#define ModulatorError_WRITE_EEPROM_FAIL				0x00000054ul
#define ModulatorError_INVALID_OUTPUT_MODE				0x00000055ul
...
#define ModulatorError_USB_EP5_INVALID_READ_SIZE		0x0300000Dul
